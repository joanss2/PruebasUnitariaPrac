...
class TakingGuidelineTest {
    ...
    TakingGuideline instruc1;                                                       // Inicializations
    TakingGuideline instruc2;

    @BeforeEach
    public void setUp() {                                                                               // Declarations
